...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container-fluid">
            ...
            <table>
                ...
                <?php
                    ...
                    <tr>
                        ...
                        <td><a href="delticket.php?ticket_no=<?php echo $res['ticket_no'];?>" data-toggle="tooltip" data-placement ="top" title="DELETE"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                        <td><a href="payticket.php?ticket_no=<?php echo $res['ticket_no'];?>" data-toggle="tooltip" data-placement ="top" title="PAY"><i class="fa fa-money" aria-hidden="true"></i></a></td>
                    </tr>
                </tbody>
            </table>
        </div>
    ...
    Swal.fire({
              title: 'Good Job!',
              text: 'Booked ticket Successfully!',
              icon: 'success',
              button: 'OK',
              });
    </script>
